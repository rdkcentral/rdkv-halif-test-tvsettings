...
* | 02 | call tvInit() -  Initialise and get a valid instance of the TV client | void | tvERROR_NONE | Should Pass |
* | 02 | call getWbInfo() -  Retrieve the white balance info with invalid getWbInfo_t input | NULL, vector<std::string>, vector<std::string>, vector<std::string> | tvERROR_INVALID_PARAM | Should Pass |
* | 03 | call getWbInfo() -  Retrieve the white balance info with invalid selector input | getWbInfo_t *, NULL, vector<std::string>, vector<std::string> | tvERROR_INVALID_PARAM | Should Pass |
* | 04 | call getWbInfo() -  Retrieve the white balance info with invalid colorTmp input | getWbInfo_t *, vector<std::string>, NULL, vector<std::string> | tvERROR_INVALID_PARAM | Should Pass |
* | 05 | call getWbInfo() -  Retrieve the white balance info with invalid input address| getWbInfo_t *, vector<std::string>, vector<std::string>, NULL | tvERROR_INVALID_PARAM | Should Pass |
* | 06 | call tvTerm() - Terminate and close the instance of the TV client | void | tvERROR_NONE | Should Pass |
* | 07 | call getWbInfo() -  Retrieve the white balance info even after tvInit() | getWbInfo_t *, vector<std::string>, vector<std::string>, vector<std::string> | tvERROR_INVALID_STATE | Should Pass |
*/
