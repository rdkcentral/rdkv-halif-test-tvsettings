...
- `High Level Test Specification` - [TV Settings High Level TestSpec](https://github.com/rdkcentral/rdkv-halif-test-tvsettings/blob/main/docs/pages/tv-settings_High_Level_Test_Spec.md)
- `Interface header` - [TV Settings HAL header](https://github.com/rdkcentral/rdkv-halif-tvsettings/blob/main/include/tvSettings.h)
...
- **componentProfile.yaml/platformProfile.yaml**
  ...
  - Example configuration file [tvSettings yaml](https://github.com/rdkcentral/rdkv-halif-test-tvsettings/blob/1.3.1/profiles/sink/Sink_4K_TvSettings.yaml)
  ...
  assets:
    device:
      Common: #List of common requirements for all the tests
        ...
        streams:
      test_SetBrightness: #Requirements for specific test
        artifacts:
        execute:
        streams:
      ...
      test2_PortConnectionStatus:
        ...
        streams:
          ...
          - "<URL>/test_4.mp4" #URL path to the test streams
    host:
      menu_config: "../../assets/tvSettings_L3_menu.yml" #Menu configuration file
```
- **menuConfig**
...
- Folder Structure
  ...
  - host
    - tests
      - helpers
        - tvSettingsTestHelper.py
      - tvSettings_test1_XYZ.py
      - tvSettings_test2_XYZ.py
