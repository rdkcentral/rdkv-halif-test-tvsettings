...
class tvSettings_test05_CheckVideoSource(utHelperClass):

    testName = "test05_CheckVideoSource"
    ...
    def __init__(self):
        """
        Initializes the test05 VideoSource test.
    ...
    def testFunction(self):
        """This function tests the VideoSource Levels
        ...
        for source,stream in zip(self.testtvSettings.getVideoSourceInfo(), self.testStreams):
            ...
            self.log.stepStart(f'videoSource Level:{source} Stream:{stream}')
...
if __name__ == '__main__':
    test = tvSettings_test05_CheckVideoSource()
    test.run(False)
