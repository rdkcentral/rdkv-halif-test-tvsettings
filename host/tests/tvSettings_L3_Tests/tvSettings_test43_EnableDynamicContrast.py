...
class tvSettings_test43_EnableDynamicContrast(utHelperClass):

    testName = "test43_EnableDynamicContrast"
    ...
    def testFunction(self):
        ...
        for stream in self.testStreams:
            ...
            for contrast in self.dynamicContrastLevels:
                self.log.stepStart(f'Set Dynamic Contrast Level: {contrast} Stream: {stream}')
...
if __name__ == '__main__':
    test = tvSettings_test43_EnableDynamicContrast()
    test.run(False)
