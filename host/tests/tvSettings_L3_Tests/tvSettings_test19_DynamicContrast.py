...
# *
# * Unless stated otherwise in this file or this component's LICENSE file the
# * following copyright and licenses apply:
# *
# * Copyright 2024 RDK Management
# *
...
class tvSettings_test19_DynamicContrast(utHelperClass):

    testName = "test19_DynamicContrast"
    ...
    def __init__(self):
        """
        Initializes the test19 DynamicContrast test.
    ...
    def testVerifyDynamicContrast(self, dynamicContrast, manual=False):
        """
        Verifies whether the Dynamic Contrast is set or not.
    ...
    def testFunction(self):
        """This function tests the Dynamic Contrast
...
if __name__ == '__main__':
    test = tvSettings_test19_DynamicContrast()
    test.run(False)
