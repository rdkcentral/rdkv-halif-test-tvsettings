...
class tvSettings_test17_AspectRatio(utHelperClass):

    testName = "test17_AspectRatio"
    ...
    def __init__(self):
        """
        Initializes the test17 AspectRatio test.
    ...
    def testVerifyAspectRatio(self, aspectRatio, manual=False):
        """
        Verifies whether the AspectRatio is set or not.
        ...
        Returns:
            bool : returns the status of AspectRatio
        """
        if manual:
    ...
    def testFunction(self):
        """This function tests the AspectRatio Levels
...
if __name__ == '__main__':
    test = tvSettings_test17_AspectRatio()
    test.run(False)
