...
class tvSettings_test35_EnableGammaMode(utHelperClass):

    testName = "test35_EnableGammaMode"
    testSetupPath = os.path.join(dir_path, "tvSettings_L3_testSetup.yml")
    moduleName = "tvSettings"
    gammaModes = [0, 1]  # Gamma mode values (0: Disable, 1: Enable)
    ...
    def testVerifyGammaMode(self, gammaMode, manual=False):
        """
        Verifies whether the gamma mode is set or not.
    ...
    def testFunction(self):
        """This function tests the Enable Gamma Mode.
...
if __name__ == '__main__':
    test = tvSettings_test35_EnableGammaMode()
    test.run(False)
