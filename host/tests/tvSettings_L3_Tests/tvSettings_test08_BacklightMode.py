...
class tvSettings_test08_BacklightMode(utHelperClass):

    testName = "test08_BacklightMode"
    ...
    def __init__(self):
        """
        Initializes the test08 BacklightMode test.
    ...
    def testVerifyBacklightMode(self, backlightMode, manual=False):
        """
        Verifies whether the BacklightMode is set or not.

        Args:
            backlightMode (int) : BacklightMode value
            manual (bool, optional): Manual verification (True: manual, False: other verification methods).
                                     Defaults to other verification methods

        Returns:
            bool : returns the status of BacklightMode
        """
        if manual:
    ...
    def testFunction(self):
        """This function tests the BacklightMode Levels
...
if __name__ == '__main__':
    test = tvSettings_test08_BacklightMode()
    test.run(False)
