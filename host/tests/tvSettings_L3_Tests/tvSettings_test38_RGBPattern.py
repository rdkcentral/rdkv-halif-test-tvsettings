...
class tvSettings_test38_RGBPattern(utHelperClass):

    testName = "test38_RGBPattern"
    ...
    def testFunction(self):
        """This function tests the RGB Pattern.
        ...
        for stream in self.testStreams:
            ...
            # Set up different values for red, green, and blue levels across 5 samples
...
if __name__ == '__main__':
    test = tvSettings_test38_RGBPattern()
    test.run(False)
