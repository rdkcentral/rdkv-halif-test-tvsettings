...
class tvSettings_test09_TVDimmingMode(utHelperClass):

    testName = "test09_TVDimmingMode"
    ...
    def __init__(self):
        """
        Initializes the test09 TVDimmingMode test.
    ...
    def testVerifyTVDimmingMode(self, TVDimmingMode, manual=False):
        """
        Verifies whether the TVDimmingMode is set or not.

        Args:
            TVDimmingMode (int) : TVDimmingMode value
            manual (bool, optional): Manual verification (True: manual, False: other verification methods).
                                     Defaults to other verification methods

        Returns:
            bool : returns the status of TVDimmingMode
        """
        if manual:
    ...
    def testFunction(self):
        """This function tests the TVDimmingMode Levels
...
if __name__ == '__main__':
    test = tvSettings_test09_TVDimmingMode()
    test.run(False)
